...
class TemplateGuesserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGuessTemplateName()
    {
        ...
        $this->assertEquals('FooBundle:Foo:student.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateNameWithParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:Bar:student.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateNameWithCascadingParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:FooBar:student.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateWithoutBundle()
    {
        ...
        $this->assertEquals(':OutOfBundle:student.html.twig', (string) $templateReference);
    }
